...
public class AdvertisingManager : MonoBehaviour {
    ...
    /// <summary>
    /// Gets or sets a value indicating whether this <see cref="T:AdvertisingManager"/> showed exit ad.
    /// </summary>
    ...
    public static void DisableAds() {
        AdvertisingManager.Instance.AdsDisabled = true;
    ...
    void OnItemPurchased(string sku) {
        if (sku.Equals("com.tedrasoft.mismatched.noads"))
            DisableAds();
